...
export const defaultCardStyles: CardStyles = {
	...
	cardBorderColor: '#e5e7eb', cardBorderWidth: 1, cardPadding: 16, cardSpacing: 8
};
...
export const defaultHeaderStyles: HeaderStyles = {
	...
	avatarShape: 'circle', avatarAlign: 'center', showCover: true, bioAlign: 'center', bioSize: 'md', bioTextColor: '#6b7280'
};
...
export const themePresets: Record<string, ThemePreset> = {
	...
	mcalpine: {
		...
		card: { enableCardBackground: true, cardBackground: '#333333', cardBackgroundOpacity: 100, cardTextColor: '#ffffff', cardBorderRadius: 12, cardShadow: true, cardShadowX: 0, cardShadowY: 4, cardShadowBlur: 10, cardBorder: false, cardBorderColor: '#444444', cardBorderWidth: 1, cardPadding: 16, cardSpacing: 8 },
		...
		header: { layout: 'overlap', coverType: 'color', coverColor: '#000000', coverGradientFrom: '#000000', coverGradientTo: '#1a1a1a', coverHeight: 160, avatarSize: 120, avatarBorder: 4, avatarBorderColor: '#ffffff', avatarShape: 'circle', avatarAlign: 'center', showCover: true, bioAlign: 'center', bioSize: 'md', bioTextColor: '#ffffff' }
	},
	yoga: {
	...
	jerry: {
		...
		card: { enableCardBackground: true, cardBackground: '#1a1a1a', cardBackgroundOpacity: 100, cardTextColor: '#ffffff', cardBorderRadius: 8, cardShadow: false, cardShadowX: 0, cardShadowY: 0, cardShadowBlur: 0, cardBorder: true, cardBorderColor: '#333333', cardBorderWidth: 1, cardPadding: 16, cardSpacing: 8 },
		...
		header: { layout: 'minimal', coverType: 'color', coverColor: '#000000', coverGradientFrom: '#000000', coverGradientTo: '#000000', coverHeight: 0, avatarSize: 72, avatarBorder: 2, avatarBorderColor: '#333333', avatarShape: 'circle', avatarAlign: 'left', showCover: false, bioAlign: 'left', bioSize: 'sm', bioTextColor: '#ffffff' }
	},
	dark: {
		...
		card: { enableCardBackground: true, cardBackground: '#1f2937', cardBackgroundOpacity: 100, cardTextColor: '#ffffff', cardBorderRadius: 12, cardShadow: true, cardShadowX: 0, cardShadowY: 4, cardShadowBlur: 10, cardBorder: false, cardBorderColor: '#374151', cardBorderWidth: 1, cardPadding: 16, cardSpacing: 8 },
		...
		header: { layout: 'glass', coverType: 'gradient', coverColor: '#1f2937', coverGradientFrom: '#4f46e5', coverGradientTo: '#7c3aed', coverHeight: 130, avatarSize: 92, avatarBorder: 3, avatarBorderColor: 'rgba(255,255,255,0.2)', avatarShape: 'circle', avatarAlign: 'center', showCover: true, bioAlign: 'center', bioSize: 'md', bioTextColor: '#ffffff' }
	},
	minimal: {
		...
		card: { enableCardBackground: false, cardBackground: '#ffffff', cardBackgroundOpacity: 100, cardTextColor: '#000000', cardBorderRadius: 0, cardShadow: false, cardShadowX: 0, cardShadowY: 0, cardShadowBlur: 0, cardBorder: true, cardBorderColor: '#000000', cardBorderWidth: 1, cardPadding: 16, cardSpacing: 8 },
		...
		header: { layout: 'side', coverType: 'color', coverColor: '#f5f5f5', coverGradientFrom: '#ffffff', coverGradientTo: '#ffffff', coverHeight: 0, avatarSize: 64, avatarBorder: 1, avatarBorderColor: '#000000', avatarShape: 'circle', avatarAlign: 'left', showCover: false, bioAlign: 'left', bioSize: 'sm', bioTextColor: '#000000' }
	},
	vibrant: {
